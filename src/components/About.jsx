  ...
  return (
    <div id="about">
      <div className="container mx-auto px-6  text-white comfortaa-light flex flex-row gap-5">
        <p className="text-2xl text-justify flex flex-col justify-center ">
        ...
        <img src="./glass.png" className="h-96 object-contain transition-transform duration-500 ease-out transform hover:scale-110 hover:rotate-3" />
      </div>
      <h1 className="container mx-auto px-6 text-white font-thin text-[2rem] sm:text-[2rem] md:text-[4rem] lg:text-[4rem] mb-3">
        Tech Stack
      </h1>
