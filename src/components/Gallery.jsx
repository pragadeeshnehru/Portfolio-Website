export default function Gallery() {
  return (
    <div class="grid grid-cols-2 md:grid-cols-4 gap-2 container mx-auto px-6 mt-20">
      ...
      <div class="grid gap-2">
        <div class="relative image-container">
          <img
            ...
            alt=""
          />
          <div class="overlay-text">I'd rather fight for my life than live it.</div>
        </div>
        <div class="relative image-container">
          <img
            class="w-full h-full object-cover"
            ...
            alt=""
          />
          <div class="overlay-text">The world will not suffer if it ends too soon.</div>
        </div>
        <div class="relative image-container">
          <img
            class="w-full h-full object-cover"
