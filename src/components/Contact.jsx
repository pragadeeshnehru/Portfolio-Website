...
export default function Contact() {
  return (
    <footer id="contact" className="mt-32 w-full bg-transparent p-8 text-white">
      <div className="flex flex-col items-center text-2xl text-center mb-24">
        <h1 className="eb-garamond">
          "And those who were seen dancing were thought to be insane by those who
          could not hear the music"
        </h1>
        <p className="eb-garamond-bold">-Nietzsche</p>
      </div>
      <div className="flex flex-row flex-wrap items-center justify-center gap-y-6 gap-x-12 text-center ">
        <ul className="flex flex-wrap justify-center items-center gap-y-2 gap-x-8">
          ...
          >
            ...
            <h1 className="font-normal transition-colors  hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-teal-300 hover:to-purple-300">
              LinkedIn
            </h1>
          </a>
          <a
            ...
            className="flex flex-col items-center"
          >
            <StackIcon name="github" className="size-10 invert" />
            <h1 className="font-normal transition-colors  hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-teal-300 hover:to-purple-300">
              Github
            </h1>
          </a>
